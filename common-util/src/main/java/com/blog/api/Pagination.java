...
public class Pagination implements Serializable {
    ...
    public static Pagination convertPage(Page page) {
        if (page == null) {
            return null;
        } else {
            return new Pagination().setCurrentPage((int) page.getCurrent()).setPageSize((int) page.getSize()).setTotal((int) page.getTotal());
        }
    }
}
